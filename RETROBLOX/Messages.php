...
<div class="msg-container">
        ...
        <?php
        if ($result->num_rows > 0) {
            // Se houver mensagens, exibe-as
          while ($row = $result->fetch_assoc()) {
    echo "<div class='message'>";
    echo "<div class='message-title'>" . htmlspecialchars($row['title']) . "</div>";
    echo "<div class='message-text'>" . htmlspecialchars($row['message_text']) ."</div>";
    echo "<div class='message-details'><span>By:</span><a href='User.php?id=" . htmlspecialchars($row['id_send']) . "'>" . htmlspecialchars($row['user_send']) . "</a>";
    echo "<img src='/images/characters/default.png' width='30'><br>";
    echo "<a href='SendMsg.php?user=" . urlencode($row['user_send']) . "'>Respond The Message</a>";
    echo "</div>";
}
        } else {
            // Se não houver mensagens
            echo "<div class='no-messages'>No messages for you.</div>";
        }
