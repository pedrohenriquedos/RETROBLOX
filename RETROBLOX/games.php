...
$sql = "SELECT id, name, creator_name, creator_id FROM game";
$result = $conn->query($sql);
        ...
        <?php if ($result->num_rows > 0): ?>
            <div class="games-list">
                <?php while ($game = $result->fetch_assoc()): ?>
                    <div class="game-item">
                        <img src="/images/games/Default.png" alt="Game Image" class="game-image">
                        <div class="game-info">
                            <h2><a href="ShowGame.php?id=<?php echo $game['id']; ?>"><?php echo htmlspecialchars($game['name'], ENT_QUOTES, 'UTF-8'); ?></a></h2>
                            <p>Created by: <a href="User.php?id=<?php echo $game['creator_id']; ?>"><?php echo htmlspecialchars($game['creator_name'], ENT_QUOTES, 'UTF-8'); ?></a></p>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
