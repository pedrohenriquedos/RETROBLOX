...
.forum-header {
    background-image: url('http://retroblox.unaux.com/images/forum/forumHeaderBackground.gif');
...
/* Estilo do título "Developer Informations" */
.title-dev {
     background-color: #d3d3d3; /* Cor de fundo cinza claro, caso a imagem falhe */
    background-image: url('http://retroblox.unaux.com/images/forum/forumHeaderBackgroundAlternate.gif');
    background-size: cover; /* A imagem cobre todo o conteúdo */
    background-position: center; /* Centraliza a imagem */
    background-repeat: no-repeat; /* A imagem não deve se repetir */
    ...
    /*min-height: 150px; /* Define uma altura mínima para o título */
}
...
.forum-category {
    background-color: #6e99c9; /* Cor de fundo da categoria */
    padding: 15px; /* Espaçamento interno */
    margin: 10px 0; /* Margem entre as categorias */
    border-radius: 8px; /* Bordas arredondadas */
...
.forum-category a:hover {
    color: #f2f2f2; /* Cor do link ao passar o mouse */
}

/* Estilo da área de informações do fórum */
.forum-info {
    margin-top: 15px;
    padding: 10px;
}
...
.forum-info a {
    color: #0077cc; /* Cor azul */
    text-decoration: none; /* Remove o sublinhado */
    font-size: 16px;
}

.forum-info a:hover {
    color: #005fa3; /* Cor azul mais escuro ao passar o mouse */
}
    </style>
</head>
<body>
    ...
    <!-- Fórum -->
        <div class="forum-container">
            ...
            <div class="forum-category">
                <img src="/images/forum/forum_status.gif" alt="Forum Status">
                <a href="ShowForum.php">General Discussion</a>
            </div>
            <div class="forum-category">
                <img src="/images/forum/forum_status.gif" alt="Forum Status">
                <a href="#">Creations Gallery</a>
            </div>
            <div class="forum-category">
                <img src="/images/forum/forum_status.gif" alt="Forum Status">
                <a href="#">Support, Bugs Report, Suggestions</a>
            </div>
